...
if("object"===(void 0===i?"undefined":u(i)))return i.v}return"denied"===this.state?this.denied(n):void navigator.geolocation.getCurrentPosition(t,function(i){1==i.code&&e.chrome&&e.chrome.webstore&&o.query(function(e){return o.state="prompt"==e.state?"temporary disabled":"denied","prompt"==e.state?o.dissmissed(n):void o.request(t,n,r)})})}}]),i}(d)),new(function(e){function o(){t(this,o)
...
navigator.requestMIDIAccess(n).then(e,function(e){return r.query(function(e){return"prompt"==e.state?r.dissmissed(t):r.denied(t)},void 0,n)})}}]),o}(d)),new(function(o){function i(){t(this,i)
